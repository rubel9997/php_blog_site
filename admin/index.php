...
$posts = new Post();
$count_user  = $user->totalUser();
$count_category  = $category->totalCategory();
$count_post  = $posts->totalPost();
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php echo $count_category;?></span></h4>
                                            <h4 class="text-muted mb-0">Total Category</h4>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col-->
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php echo $count_post;?></span></h4>
                                            <h4 class="text-muted mb-0">Total Post</h4>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col-->
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php echo $count_user;?></span></h4>
                                            <h4 class="text-muted mb-0">Users</h4>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col-->
